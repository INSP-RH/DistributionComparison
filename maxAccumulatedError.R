# The function maxAccumulatedError calculates the maximum accumulated error between the real cummulative distribution 
...
maxAccumulatedError <- function(y, pop, distribution="norm"){
  ...
  # Maximum cummulative error from -Inf  to the minimum value between y and M
  ...
  maxAccumError <- firstTerm + secondTerm
  return(maxAccumError)
}